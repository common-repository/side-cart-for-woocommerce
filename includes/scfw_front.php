    ...
    class SCFW_front {
        ...
        function SCFW_cart_create() {
            ...
            <div class="wfc_container" style="width: <?php echo $wfc_sidecart_width; ?>; right: -<?php echo $wfc_sidecart_width; ?>;">
                    ...
                    <?php
                        ...
                        if ( ! WC()->cart->is_empty() ) :
                                    ...
                                    $html .= "</div>";
                                       ...
                                       $html .= "<h3 class='empty_cart_text'>".get_option( 'wfc_cart_is_empty', 'Cart is empty')."</h3>";
                                endif;
                        $html .= '</div>';
                        echo $html;
                    ?>
                ...
                <div class="wfc_footer">
                    ...
                    <?php  if(get_option( 'wfc_cart_option', 'yes' ) == "yes") { ?>
                        <a class="wfc_bn_1" href="<?php echo wc_get_cart_url();?>" style="background-color: <?php echo get_option( 'wfc_ft_btn_clr', '#766f6f') ?>;margin: <?php echo get_option( 'wfc_ft_btn_mrgin', '5')."px" ?>;color: <?php echo get_option( 'wfc_ft_btn_txt_clr', '#ffffff') ?>;">
                            <?php echo get_option( 'wfc_cart_txt', 'View Cart'); ?>
                        </a>
                    <?php } ?>
                    <?php  if(get_option( 'wfc_checkout_option', 'yes' ) == "yes"){ ?>
                        <a class="wfc_bn_2" href="<?php echo wc_get_checkout_url(); ?>" style="background-color: <?php echo get_option( 'wfc_ft_btn_clr', '#766f6f') ?>;margin: <?php echo get_option( 'wfc_ft_btn_mrgin', '5')."px" ?>;color: <?php echo get_option( 'wfc_ft_btn_txt_clr', '#ffffff') ?>;">
                            <?php echo get_option( 'wfc_checkout_txt', 'Checkout'); ?>
                        </a>
                    <?php } ?>
                    <?php  if(get_option( 'wfc_conshipping_option', 'yes' ) == "yes"){ ?>
                        <a class="wfc_bn_3" href="<?php echo get_option( 'wfc_conshipping_link', '#' ) ?>" style="background-color: <?php echo get_option( 'wfc_ft_btn_clr', '#766f6f') ?>;margin: <?php echo get_option( 'wfc_ft_btn_mrgin', '5')."px" ?>;color: <?php echo get_option( 'wfc_ft_btn_txt_clr', '#ffffff') ?>;">
            ...
            <?php if(get_option( 'wfc_show_cart_icn', 'yes' ) == "yes"){ ?>
                <div class="wfc_cart_basket" style="<?php if(get_option('wfc_basket_position') == "top"){ ?>top: 15px;<?php }elseif (get_option('wfc_basket_position', 'bottom') == "bottom") { ?>bottom: 15px;<?php } ?>;max-height: <?php echo get_option( 'wfc_basket_icn_size', '60')."px" ?>;max-width: <?php echo get_option( 'wfc_basket_icn_size', '60')."px" ?>;background-color: <?php echo get_option( 'wfc_basket_bg_clr', '#cccccc') ?>;">
                    <div class="cart_box">
        ...
        function SCFW_single_added_to_cart_event()
        {
            ...
            ?>
            <?php $wfc_sidecart_width = get_option( 'wfc_sidecart_width', '350').'px'; ?>
