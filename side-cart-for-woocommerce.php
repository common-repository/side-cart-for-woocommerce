...
if (!class_exists('SCFW')) {
  	...
  	class SCFW {
	    ...
	    function includes() {
	      	...
	      	include_once('includes/scfw_kit.php');
    	...
    	function SCFW_plugin_row_meta( $links, $file ) {
            if ( SCFW_BASE_NAME === $file ) {
                $row_meta = array(
                    'rating'    =>  ' <a href="https://www.xeeshop.com/woocommerce-floating-cart/" target="_blank">Documentation</a> | <a href="https://www.xeeshop.com/support-us/?utm_source=aj_plugin&utm_medium=plugin_support&utm_campaign=aj_support&utm_content=aj_wordpress" target="_blank">Support</a> |<a href="https://wordpress.org/support/plugin/side-cart-for-woocommerce/reviews/?filter=5" target="_blank"><img src="'.SCFW_PLUGIN_DIR.'/images/star.png" class="scfw_rating_div"></a>',
                );
